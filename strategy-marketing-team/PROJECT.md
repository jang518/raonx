...
| WB-002 | todo | Codex | `export/` CSV 4개 구조 확인 및 대시보드 입력 데이터 스키마 초안 작성 | `docs/data-schema.md`, `output/data_profile_dashboard-foundation.md` | dashboard-foundation | 2026-06-04 |

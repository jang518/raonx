...
* [2026-06-06 00:00] ChatGPT / changed: `AGENTS.md`를 Codex 실행 지침으로 재정리하고 `dashboard/` 기준, CSV 검증, 서버 반영, 권한, 금지사항 반영 / verified: AGENTS.md 수정본에서 목적·역할·데이터 경계·5개 화면·incoming-data-backup 흐름 확인 / next: CLAUDE.md도 `dashboard/` 기준과 최신 협업 규칙에 맞게 정합성 점검 필요
